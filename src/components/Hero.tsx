...
const Hero = () => {
    ...
    return (
        <section ref={sectionRef} className="relative w-full h-[100vh] min-h-[700px] bg-[#0B0F14] overflow-hidden">
            ...
            {/* ── Main Hero Content ── */}
            <div className="relative z-10 h-full w-full flex items-start pt-[140px] md:pt-[180px] pb-12 px-6 md:px-xl">
                <div className="max-w-[1440px] mx-auto w-full grid grid-cols-12 gap-md">
                    <div className="col-span-12 md:col-span-8 lg:col-span-7 space-y-8">
                        <div className="inline-flex items-center gap-3 sm:gap-4 px-4 sm:px-5 py-2 rounded-full border border-blueprint-accent/30 bg-blueprint-accent/5 backdrop-blur-xl">
                            <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-blueprint-accent animate-pulse" />
                            <span className="text-blueprint-accent text-[9px] sm:text-[11px] font-black tracking-[0.3em] uppercase font-sans">
                                The Future of Interior Utilities
                            </span>
                        </div>

                        <h1 className="text-[38px] sm:text-5xl md:text-6xl lg:text-7xl text-blueprint-text leading-[0.95] sm:leading-[0.93] font-bold tracking-tighter">
                            CLEANING<br />
                            <span className="text-blueprint-accent">INFRA</span>STRUCTURE<br />
                            REDEFINED
                        </h1>

                        <p className="text-base sm:text-lg md:text-xl text-blueprint-text/80 max-w-lg font-medium leading-relaxed font-sans">
                        ...
                        <div className="flex flex-col sm:flex-row gap-5 pt-2">
                            <Link to="/contact" className="px-10 py-5 bg-blueprint-text text-blueprint-bg font-black rounded-button hover:bg-blueprint-accent hover:text-white transition-all duration-300 text-[11px] uppercase tracking-[0.2em] text-center">
                        ...
                        <div className="pt-8 grid grid-cols-2 sm:grid-cols-3 gap-6 sm:gap-8 border-t border-white/5">
