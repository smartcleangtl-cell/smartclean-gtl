            ...
            <div className="max-w-7xl mx-auto space-y-24">
                ...
                <div className="grid grid-cols-12 gap-md items-center">
                    <div className="col-span-12 lg:col-span-7 space-y-md">
                        <div className="inline-block px-4 py-1 rounded-full border border-blueprint-accent/40 bg-blueprint-accent/5 text-blueprint-accent text-[12px] font-bold tracking-[0.4em] uppercase font-sans">
                            Reliability Protocol
                        </div>
                        <h2 className="text-blueprint-text uppercase">
                            WHY CENTRAL <br /> <span className="text-blueprint-accent">VACUUM SYSTEMS?</span>
                        </h2>
                        <p className="text-lg text-blueprint-text/85 font-normal leading-relaxed max-w-2xl font-sans">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-8">
                            <div className="space-y-4 group text-center md:text-left">
                                ...
                                <p className="text-[15px] text-blueprint-text/80 font-sans leading-relaxed">The motor unit is located outside the living area, reducing noise inside the home.</p>
                            </div>
                            <div className="space-y-4 group text-center md:text-left">
                                <div className="p-4 bg-blueprint-surface/40 border border-white/5 shadow-2xl w-fit rounded-button group-hover:border-blueprint-accent/30 transition-blueprint mx-auto md:mx-0">
                                ...
                                <p className="text-[15px] text-blueprint-text/80 font-sans leading-relaxed">Dust and allergens are extracted away from the house instead of recirculating.</p>
                            </div>
                            <div className="space-y-4 group text-center md:text-left pt-8">
                                ...
                                <p className="text-[15px] text-blueprint-text/80 font-sans leading-relaxed">Once installed, the system becomes a permanent cleaning solution built into the structure of the home.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-16 border-t border-white/5 pt-20">
                    <div className="space-y-4">
                        <div className="flex items-center gap-3 font-bold tracking-[0.4em] uppercase text-[12px] text-blueprint-accent font-sans">
                            <Clock size={14} /> Permanence
                        </div>
                        <p className="text-[14px] text-blueprint-text/60 leading-relaxed font-normal font-sans">
